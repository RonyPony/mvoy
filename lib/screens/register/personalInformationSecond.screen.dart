...
class PersonalInfoSecondScreen extends StatefulWidget {
  ...
  const PersonalInfoSecondScreen({super.key});
...
class _PersonalInfoSecondScreenState extends State<PersonalInfoSecondScreen> {
  ...
  _buildFields() {
    return const Column(
      children: [
        MvoyTextField(placeHolder: "correo electronico"),
        MvoyTextField(placeHolder: "telefono"),
        MvoyTextField(placeHolder: "direccion"),
        MvoyTextField(placeHolder: "nombre de un familiar"),
        MvoyTextField(placeHolder: "telefono del familiar"),
        MvoyBooleanSelectorField(
            placeHolder: "sexo", option1Text: "M", option2Text: "F"),
      ],
    );
  }
